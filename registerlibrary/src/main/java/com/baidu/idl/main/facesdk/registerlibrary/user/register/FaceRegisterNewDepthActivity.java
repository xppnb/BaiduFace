 ...
 */
public class FaceRegisterNewDepthActivity extends BaseOrbbecActivity implements View.OnClickListener,
        OpenNIHelper.DeviceOpenListener, ActivityCompat.OnRequestPermissionsResultCallback {
    private static final String TAG = FaceRegisterNewDepthActivity.class.getSimpleName();
    ...
    private com.baidu.idl.main.facesdk.registerlibrary.user.camera.AutoTexturePreviewView mAutoTexturePreviewView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initListener();
        setContentView(R.layout.activity_new_registerlibrary_depth);
        ...
        if (FaceSDKManager.initStatus != FaceSDKManager.SDK_MODEL_LOAD_SUCCESS) {
            FaceSDKManager.getInstance().initModel(this, new SdkInitListener() {
                ...
                public void initModelSuccess() {
                    ToastUtils.toast(FaceRegisterNewDepthActivity.this, "模型加载成功，欢迎使用");
                }

                @Override
                public void initModelFail(int errorCode, String msg) {
                    if (errorCode != -12) {
                        ToastUtils.toast(FaceRegisterNewDepthActivity.this, "模型加载失败，请尝试重启应用");
                    }
                }
            });
        }
    ...
    private void initView() {
        ...
        mCircleHead.setBorderWidth(DensityUtils.dip2px(FaceRegisterNewDepthActivity.this,
                3));
    ...
    private void checkData() {
        ...
        FaceSDKManager.getInstance().onDetectCheck(rgbData, null, depthData, RGB_HEIGHT,
                RGB_WIDTH, 3, 2, new FaceDetectCallBack() {
                    @Override
...
//                }
            ...
            boolean isSuccess = FaceApi.getInstance().registerUserIntoDBmanager(null,
                    userName, imageName,null,null, null,null,null, mFeatures);
            if (isSuccess) {
                // 保存人脸图片
