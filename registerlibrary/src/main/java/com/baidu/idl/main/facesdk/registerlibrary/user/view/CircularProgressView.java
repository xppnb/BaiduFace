...
/**
 * 圆形进度条控件
 * Created by liujialu on 2020/02/18.
 */
public class CircularProgressView extends View {

    private Paint mBackPaint;   // 绘制画笔
    ...
    public CircularProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mBackPaint.setStrokeWidth(typedArray.getDimension(R.styleable.CircularProgressView_backWidth,
                5));
        mBackPaint.setColor(typedArray.getColor(R.styleable.CircularProgressView_backColor,
                Color.LTGRAY));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mRectLength = (int) ((viewWide > viewHigh ? viewHigh : viewWide)
                - (mBackPaint.getStrokeWidth() > mProgPaint.getStrokeWidth()
                ? mBackPaint.getStrokeWidth() : mProgPaint.getStrokeWidth()));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(mRectF, 275, 360 * mProgress / 100,
                false, mProgPaint);
    }
