...
//        featureSql.append(" update_time").append(" long )");
        ...
        userSql.append(" is_class").append(" varchar(32) default \"\"   ,");
        userSql.append(" is_accommodation").append(" varchar(32) default \"\"   ,");
        userSql.append(" user_school").append(" varchar(32) default \"\"   ,");
        userSql.append(" user_college").append(" varchar(32) default \"\"   ,");
        ...
        recordSql.append(" is_class").append(" varchar(32) default \"\"   ,");
        recordSql.append(" is_accommodation").append(" varchar(32) default \"\"   ,");
        recordSql.append(" user_school").append(" varchar(32) default \"\"   ,");
        recordSql.append(" user_college").append(" varchar(32) default \"\"   ,");
        ...
        try {
            ...
            Log.i(TAG, "createTables: 创建成功");
        } catch (Exception e) {
            Log.i(TAG, "createTables: 创建失败");
            e.printStackTrace();
        }
    }
}
