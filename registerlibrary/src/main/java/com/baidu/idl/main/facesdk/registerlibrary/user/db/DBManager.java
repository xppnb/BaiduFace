package com.baidu.idl.main.facesdk.registerlibrary.user.db;
...
import com.baidu.idl.main.facesdk.registerlibrary.user.model.Group;
...
public class DBManager {
    ...
    public boolean addUser(User user) {
        ...
        try {
            ...
            cv.put("is_class", user.getUserClass());
            cv.put("is_accommodation", user.getUserAccommodation());
            cv.put("user_college", user.getUserCollege());
            cv.put("user_school", user.getUserSchool());
            ...
            Log.i(TAG, "addUser: " + user.getUserCollege() + " " + user.getUserSchool());
    ...
    public List<User> queryAllUsers() {
        ...
        try {
            ...
            while (cursor != null && cursor.getCount() > 0 && cursor.moveToNext()) {
                ...
                String isClass = cursor.getString(cursor.getColumnIndex("is_class"));
                String isAccommodation = cursor.getString(cursor.getColumnIndex("is_accommodation"));
                ...
                Log.i(TAG, "queryAllUsers: " + userName + " " + isClass + " " + isAccommodation + " " + imageName + " " + college + " " + school);
                ...
                user.setUserAccommodation(isAccommodation);
                user.setUserCollege(college);
                user.setUserSchool(school);
                user.setUserClass(isClass);
                user.setCtime(ctime);
