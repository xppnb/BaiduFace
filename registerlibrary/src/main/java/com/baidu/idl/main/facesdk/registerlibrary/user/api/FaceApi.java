 ...
 */
package com.baidu.idl.main.facesdk.registerlibrary.user.api;
...
public class FaceApi {
    ...
    public static final String TAG = "FaceApi";
    ...
    public boolean registerUserIntoDBmanager(String groupName, String userName, String picName,
                                             String userInfo, String isClass, String isAccommodation,String college,String school, byte[] faceFeature) {
        ...
        Log.i(TAG, "registerUserIntoDBmanager: " + college + " " + school);
        // 添加用户信息到数据库
