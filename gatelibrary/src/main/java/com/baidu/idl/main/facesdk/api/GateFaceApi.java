...
import com.baidu.idl.main.facesdk.model.ImportFeatureResult;
...
public class GateFaceApi {
    private static GateFaceApi instance;
    ...
    public static synchronized GateFaceApi getInstance() {
        if (instance == null) {
            instance = new GateFaceApi();
        }
        return instance;
    }
...
//    }
    ...
    public boolean registerUserIntoDBmanager(String groupName, String userName, String picName,
        ...
        // 添加用户信息到数据库
        return GateFaceApi.getInstance().userAdd(user);
    }
    ...
    public void initDatabases(final boolean isFeaturePush) {
        ...
        future = es.submit(new Runnable() {
            ...
            public void run() {
                ...
                List<User> listUser = GateFaceApi.getInstance().getAllUserList();
