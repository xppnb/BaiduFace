    ...
    public List<User> queryAllUsers() {
        ...
        try {
            ...
            while (cursor != null && cursor.getCount() > 0 && cursor.moveToNext()) {
                ...
                String college = cursor.getString(cursor.getColumnIndex("user_college"));
                String school = cursor.getString(cursor.getColumnIndex("user_school"));
                ...
                Log.i(TAG, "queryAllUsers: "  + userName + " " + isClass + " " + isAccommodation + " " + imageName);
